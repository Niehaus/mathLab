...
public class CameraController : MonoBehaviour
{
    ...
    void LateUpdate() {
        ...
        if (transform.position != target.position) { //dá um certo smooth movement à câmera, a faz andar atrás do player, e colocá-la sobre ele quando ele parar de andar(followup)
